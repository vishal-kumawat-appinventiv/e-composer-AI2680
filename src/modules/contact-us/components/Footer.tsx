import { FOOTER_IMG, FOOTER_LINKS } from "../../../utils/mock";

const Footer = () => {
  return (
    <section className="max-w-[75%] mx-auto px-4 mt-10 mb-20">
      <div className="grid grid-cols-1 lg:grid-cols-[30%_64%] gap-20  w-full">
